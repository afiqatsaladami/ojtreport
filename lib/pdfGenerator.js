...
// Header punya teks 3 baris ("Paraf/ Ttd Mentor") jadi butuh ruang lebih tinggi
// dari sekadar 1 baris teks. Nilai ini dibuat lega + ada buffer supaya tidak
// pernah meluber ke halaman berikutnya.
const HEADER_ROW_HEIGHT = 24; // tinggi baris judul kolom (mm)
const FOOTER_RESERVE = 24; // ruang disisakan di bawah untuk nama instansi + buffer aman (mm)
